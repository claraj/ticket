...
// display user choice if they want to add ticket, delete ticket, display all ticket, detelet ticket by issue, search by name  or quit the program
    ...
    protected static void addTickets(LinkedList<Ticket> ticketQueue) {
        ...
        String description;
        String reporter;
        // use todays date assuming all tickets are created today, for testing. We can change this later if needed
        ...
        while (moreProblems) {
            ...
            System.out.println("More tickets to add? press n for no");
    ...
    protected static void printAllTickets(LinkedList<Ticket> tickets) {
        ...
        for (Ticket t : tickets ) {
            System.out.println(t); //Write a toString method in com.happy.Ticket class
